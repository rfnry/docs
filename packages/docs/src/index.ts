...
const ROUTES: ReadonlyArray<{ pattern: string; entrypoint: string }> = [
  ...
  { pattern: "/[locale]/[pkg]", entrypoint: "@rfnry/docs/routes/package-index.astro" },
  { pattern: "/[locale]/[pkg]/llms.txt", entrypoint: "@rfnry/docs/routes/package-llms.txt.ts" },
  { pattern: "/[locale]/[pkg]/llms-full.txt", entrypoint: "@rfnry/docs/routes/package-llms-full.txt.ts" },
  { pattern: "/[locale]/[pkg]/[version]/[...slug]", entrypoint: "@rfnry/docs/routes/slug.astro" },
  { pattern: "/[locale]/[pkg]/[version]/[...slug].md", entrypoint: "@rfnry/docs/routes/slug.md.ts" },
  { pattern: "/[locale]/[pkg]/[version]/llms.txt", entrypoint: "@rfnry/docs/routes/llms.txt.ts" },
  { pattern: "/[locale]/[pkg]/[version]/llms-full.txt", entrypoint: "@rfnry/docs/routes/llms-full.txt.ts" },
